...
/**
 * Parameters for updating an existing terminology substitution rule.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class UpdateTerminologySubstitutionRequest {
    ...
    private UpdateTerminologySubstitutionRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateTerminologySubstitutionRequest build() {
            ...
            return new UpdateTerminologySubstitutionRequest(this);
        }
    }
}
